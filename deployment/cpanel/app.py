...
CPANEL_ROOT = Path(__file__).resolve().parent
REPOSITORY_ROOT = CPANEL_ROOT.parents[1]
ROOT = Path(os.environ.get("STRUCTURED_USE_CASE_EDITOR_ROOT", REPOSITORY_ROOT)).resolve()
...
if __name__ == "__main__":
    ...
    with make_server("127.0.0.1", port, application) as server:
        print(f"Serving Use Case Editor at http://127.0.0.1:{port}/")
